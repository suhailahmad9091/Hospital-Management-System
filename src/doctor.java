    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        else
        {
            ...
            if(w.matches("^[0-9]{1,3}"))
            {
                ...
                JOptionPane.showMessageDialog(null, "Doctor ID and Password is not correct");
            ...
            if(check==true)
            {
                ...
                try
                {
                    ...
                    while(rs.next())
                    {
                        if(rs.getInt(1)==did && rs.getString(2).compareTo("Doctor")==0 && (rs.getString(3).compareTo(pwd)==0 ))
                        {
                            flag = true;
                            break;
                        }
